...
// Создаем привязку объекта "objC" как прототипа объекта "objB", используя для этого метод - "Object.create()". 
...
// Создаем привязку объекта "objB" как прототипа объекта "objA", используя для этого метод - "Object.create()". 
