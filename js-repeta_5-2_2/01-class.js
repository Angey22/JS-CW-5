...
//! Геттеры и сеттеры являются функционалом объекта, и при необходимости могут быть использованы в коде любого объекта, не только в классе.
